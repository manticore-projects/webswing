...
public abstract class AbstractUrlHandler implements UrlHandler, SecurableService {
    ...
    /**
     * Matches CR (\r) and LF (\n) characters, including URL-encoded variants
     * (%0d / %0a, case-insensitive). Used to reject Origin header values that
     * would otherwise allow CRLF injection into response headers.
     */
