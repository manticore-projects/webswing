        ...
        for (String watcher : watchers) {
            try {
                ...
                for (String wp : watchPaths) {
                    ...
                    if (!candidate.startsWith(base.normalize())) {
                        System.err.println("Skipping watchPath outside base directory for watcher '"
                                                   + watcher + "': " + wp);
                        continue;
                    }
                ...
                if (!workDirResolved.startsWith(base.normalize())) {
                    System.err.println("Skipping watcher '" + watcher
                                               + "': workDir escapes base directory: " + workDir);
                    continue;
                }
