...
public class BufferedImageGraphicsConfig extends GraphicsConfiguration {
  ...
  public static BufferedImageGraphicsConfig getConfig(BufferedImage bImg, double scaleX,
      double scaleY) {
    ...
    if (type > 0 && type < numconfigs) {
      ...
      if (ret != null && ret.getNormalizingTransform().getScaleX() == scaleX
          && ret.getNormalizingTransform().getScaleY() == scaleY) {
        return ret;
      }
    }
  ...
  public BufferedImageGraphicsConfig(BufferedImage bufImg, Component comp, double scaleX,
      double scaleY) {
    if (comp == null) {
  ...
  public ColorModel getColorModel(int transparency) {
    ...
    return switch (transparency) {
      ...
      case Transparency.TRANSLUCENT -> ColorModel.getRGBdefault();
      default -> null;
    };
  }
